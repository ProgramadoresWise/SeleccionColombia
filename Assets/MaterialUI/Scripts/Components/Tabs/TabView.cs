...
//			if(NavigatorManager.main.isTapPanel)
        ...
        public void TabPagePointerUp(float delta)
        {
            ...
            if (m_CanScrollBetweenTabs)
            {
                ...
                {
                    SetPage(NearestPage());
					if(!calendarData.changeCalendarActive){
						if( !this.tabs[m_CurrentPage].gameObject.GetComponent<ButtonsubPanel>().IgnoredComponentPanel &&  this.tabs.Length > NearestPage())
							NavigatorManager.main.saveIndex (NavigatorManager.main.actualPanel, (NearestPage()),NavigatorManager.main.panelsPrincipales[NavigatorManager.main.actualPanel].subPanelsButtons[NearestPage()].GetComponent<ButtonsubPanel>().titleSubpanel);
					}
                }
                else
                {
                    if (delta < 0)
                    {
						...
						if(!calendarData.changeCalendarActive){
							if( !this.tabs[m_CurrentPage].gameObject.GetComponent<ButtonsubPanel>().IgnoredComponentPanel && this.tabs.Length > NearestPage(1) )
								NavigatorManager.main.saveIndex (NavigatorManager.main.actualPanel, NearestPage(1),NavigatorManager.main.panelsPrincipales[NavigatorManager.main.actualPanel].subPanelsButtons[NearestPage(1)].GetComponent<ButtonsubPanel>().titleSubpanel);
						}
				...
				if(!calendarData.changeCalendarActive){
					if( !this.tabs[m_CurrentPage].gameObject.GetComponent<ButtonsubPanel>().IgnoredComponentPanel ){
						NavigatorManager.main.panelsPrincipales[NavigatorManager.main.actualPanel].subPanelsButtons[NavigatorManager.main.actualSubPanel].GetComponent<ButtonsubPanel>().setImageBtn();
						//					NavigatorManager.main.saveIndex (NavigatorManager.main.actualPanel, (NearestPage(-1)),NavigatorManager.main.panelsPrincipales[NavigatorManager.main.actualPanel].subPanelsButtons[NavigatorManager.main.actualSubPanel].GetComponent<ButtonsubPanel>().titleSubpanel);
					}
				}
            }
        }
