...
namespace MaterialUI
{
    ...
    public class DialogDatePicker : MaterialDialog
    {
		...
		public void SetDayOfWeek(DayOfWeek dayOfWeek, CultureInfo cultureInfo)
		{
			...
			{
				m_CultureInfo = new CultureInfo("es-ES");
			}
        ...
        private void UpdateDatesText()
        {
            ...
            m_TextDate.text = GetFormattedDate(m_CurrentDate).ToUpper();
        }
        ...
        public void OnPreviousMonthClicked()
        {
			...
			SetDate(new DateTime(date.Year, date.Month, System.DateTime.DaysInMonth(date.Year, date.Month) ));
			Debug.Log(System.DateTime.DaysInMonth(date.Year, date.Month));
        }

        public void OnNextMonthClicked()
        {
			m_CurrentDate = new DateTime(m_CurrentDate .Year, m_CurrentDate .Month, System.DateTime.DaysInMonth(m_CurrentDate.Year, m_CurrentDate.Month) );
            DateTime date = m_CurrentDate;
            date = date.AddMonths(1);
