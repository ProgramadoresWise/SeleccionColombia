...
public class NavigationButtonActionScript : MonoBehaviour {
	...
	void Start () {
		...
		gameObject.GetComponent<Button> ().onClick.AddListener (() => OpenOtherPanel(currentPanel, nextPanel, disableCurrentPanel));
	}
